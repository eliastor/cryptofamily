...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 7.2\common\bin\cspybat" -f "C:\projects\cryptofamily\settings\crypto.Debug.general.xcl" --backend -f "C:\projects\cryptofamily\settings\crypto.Debug.driver.xcl" 
